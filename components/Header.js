      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#faf8f5]/95 backdrop-blur-sm border-b border-[#e8e0d5]">
        ...
        {menuOpen && (
          <div className="md:hidden bg-[#faf8f5] border-t border-[#e8e0d5] px-6 py-6">
            ...
            {/* Social w menu mobilnym */}
            <div className="mt-8 pt-6 border-t border-[#e8e0d5] flex gap-4">
              <a href="https://www.instagram.com/bellivia.style" target="_blank" rel="noopener noreferrer" className="text-xs tracking-widest uppercase text-[#888] hover:text-[#d4a853]">Instagram</a>
              <span className="text-[#d4a853]">·</span>
              <a href="https://www.tiktok.com/@bellivia.style" target="_blank" rel="noopener noreferrer" className="text-xs tracking-widest uppercase text-[#888] hover:text-[#d4a853]">TikTok</a>
              <span className="text-[#d4a853]">·</span>
              <a href="https://www.facebook.com/profile.php?id=61589264261596" target="_blank" rel="noopener noreferrer" className="text-xs tracking-widest uppercase text-[#888] hover:text-[#d4a853]">Facebook</a>
            </div>
          </div>
        )}
      </header>

      {/* Spacer żeby treść nie chowała się pod headerem */}
